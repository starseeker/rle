/*
 * rle.hpp - Hardened, production-oriented, clean-room C++ header-only
 *           implementation of the Utah Raster Toolkit RLE image format.
 *
 ...
 *   - std::chrono civil date timestamp (no platform ifdefs).
 *
