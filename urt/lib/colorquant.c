 ...
 * $Id: colorquant.c,v 3.0 90/08/03 15:20:11 spencer Exp $
 *
 * $Log:	colorquant.c,v $
 ...
 *	otherimages		If non-zero, the rgbmap will be a complete
 *				inverse map.  This is necessary when the map
 *				will be reused for other images or for
 *				dithering.
 *
 ...
 */
int
colorquant(red,green,blue,pixels,colormap,colors,bits,rgbmap,fast,otherimages)
unsigned char *red, *green, *blue;
unsigned long pixels;
unsigned char *colormap[3];
int colors, bits;
unsigned char *rgbmap;
int fast, otherimages;
{
 ...
 */
static void
ComputeRGBMap(boxes, colors, rgbmap, bits, colormap, fast, otherimages)
Box *boxes;
int colors;
unsigned char *rgbmap, *colormap[3];
int bits, fast, otherimages;
{
	register int i;
